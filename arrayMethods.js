...
// CODE HERE
let taxedPrice = orders.map(function(element){
...
// let bobsTotal = purchases.reduce((runningTotal, element) => {
//   let {owner, price} = element
//   if (owner === "Bob"){
//     return runningTotal + price
//   }
// }, 0)

let bobsTotal = purchases.filter((element) => element.owner === "Bob").reduce((runningTotal, element) => runningTotal + element.price, 0)
