...
function multiply(number1,number2,func){
...
let contains = (array, name, callback) => callback(array.includes(name))
...
*/
// function callbackFunc5(uniqArr){
